...
const (
	signalName = "hits"
	subject    = "count.asia.hits"
	streamName = "COUNTER_ASIA"
)

var (
	nodeName  = getEnv("NODE_NAME", "asia")
	nodeColor = getEnv("NODE_COLOR", "#f97316")
	nodeTitle = getEnv("NODE_TITLE", "Asia")
)
...
func main() {
	...
	log.Println("stream COUNTER_ASIA ready")
